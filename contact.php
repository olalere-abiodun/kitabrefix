...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $to      = "info@kitabservices.com";  
    $subject = "New Contact Form Message from $firstName $lastName";
    $body    = "Name: $firstName $lastName\nEmail: $email\nPhone: $phone\n\nMessage:\n$message";
    $headers = "From: $email";

    if (mail($to, $subject, $body, $headers)) {
        $messageStatus = "<span class='text-success'>✅ Message sent successfully!</span>";
    } else {
        $messageStatus = "<span class='text-danger'>❌ Message sending failed. Please try again.</span>";
    }
}
?>
<!doctype html>
...
<body>
                ...
                <div class="col-md-6">
                    <div class="h-100 p-4 p-md-4 p-sm-3 p-2 rounded-3">
                        ...
                        <div class="row align-items-center mb-3 g-4">
                            <div class="col-auto">
                                <img src="svg/contact.svg" alt="" style="width: 40px; height: 40px;">
                            </div>
                            <div class="col">
                                ...
                                <p class="small mb-0" style="color:#726e6e; font-weight: 500;">0905 909 0757</p>
                                <p class="small mb-0" style="color:#726e6e; font-weight: 500;">0905 909 0813</p>
                            </div>
                        </div>
                        <div class="row align-items-center mb-3 g-4">
                            <div class="col-auto">
                                <img src="svg/email.svg" alt="" style="width: 40px; height: 40px;">
                            </div>
                            <div class="col">
                                <h6 class="mb-0 fw-bold">Email</h6>
                                <p class="small mb-0" style="color:#726e6e; font-weight: 500;">info@kitabservices.com
                                </p>
                        ...
                        <div class="row align-items-center mb-3 g-4">
                            <div class="col-auto">
                                <img src="svg/address.svg" alt="" style="width: 40px; height: 40px;">
                            </div>
                            <div class="col">
                                <h6 class="mb-0 fw-bold">Address</h6>
                                <p class="small mb-0" style="color:#726e6e; font-weight: 500;"> 1 Ogunnusi Rd Opp
                                    Excellent hotel Ogba Lagos</p>
            ...
            <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5 px-5 border-top text-white">
                <div class="col mb-3"> <a href="/"
                    ...
                    <div class="social-icons mt-3">
                        ...
                        <a href="#" class="me-2" title="Instagram"><i class="bi bi-instagram"></i></a>
    ...
    <div class="floating-button-group">
        <!-- Arrow Up Button -->
        <button id="scrollToTopBtn" aria-label="Scroll to top" class="scroll-top-btn">
    ...
    <!-- Optional WhatsApp Chat Box (popup) -->
    <div id="chat-box" class="chat-box" style="display: none;">
        <p>👋 Hi! How can we help you?</p>
        <a href="https://wa.me/2349060064364" target="_blank">Start Chat on WhatsApp</a>
    </div>
